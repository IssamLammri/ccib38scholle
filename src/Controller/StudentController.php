...
class StudentController extends AbstractController
{
    ...
    #[Route('/{id}', name: 'app_student_show',options: ['expose' => true],  methods: ['GET'])]
    ...
    #[Route('/{id}/edit', name: 'app_student_edit',options: ['expose' => true], methods: ['GET', 'POST'])]
    ...
    #[Route('/{id}', name: 'app_student_delete',options: ['expose' => true], methods: ['POST'])]
