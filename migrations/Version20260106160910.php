 ...
 */
final class Version20260106160910 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE study_class ADD active TINYINT(1) DEFAULT 1');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE study_class DROP active');
